...
if __name__ == "__main__":
    ...
    if params.task == "retrieval":
        ...
        json_path = "/home/habang8/muscall/data/datasets/audiocaption/tag/dataset_test.json" 
        npy_dir = "/home/habang/muscall/Dataset/npy"
        evaluation = Zeroshot(muscall_config, json_path, npy_dir)
    else:
